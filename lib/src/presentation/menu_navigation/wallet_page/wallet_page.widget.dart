...
import 'package:flutter_vcx_demo/src/presentation/menu_navigation/wallet_page/start_aries_sdk_form/start_aries_sdk_form.widget.dart';
      ...
      child: Column(
        children: [
          ExpansionTile(
            ...
            children: [StartAriesSdkFormWidget()],
          )
        ],
      ),
    );
