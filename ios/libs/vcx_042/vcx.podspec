#
#  Be sure to run `pod spec lint vcx.podspec' to ensure this is a
...
The Initial mobile app on the iOS platform will call into the libvcx shared library 
from Objective-C.
                   DESC

  spec.homepage     = "https://github.dev/hyperledger/aries-vcx"
  ...
  spec.source       = { :http => "https://github.com/hyperledger/aries-vcx/releases/download/0.38.0/libvcx-ios-0.38.0-universal.zip" }
